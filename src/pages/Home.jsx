    ...
    <main>
      ...
      <section style={{
        ...
        <div style={{
          ...
          background: 'linear-gradient(135deg, rgba(162,62,22,0.18), transparent 30%), linear-gradient(225deg, rgba(58,38,8,0.1), transparent 36%)',
          pointerEvents: 'none',
        }} />
        {/* floating blobs */}
        <div style={{ position: 'absolute', width: 480, height: 480, borderRadius: '50%',
          background: 'radial-gradient(circle, rgba(162,62,22,0.14) 0%, transparent 68%)',
        ...
        <motion.div variants={stagger} initial="hidden" animate="visible"
          ...
          <motion.div variants={fadeUp} style={{ marginBottom: '1.5rem', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.75rem', flexWrap: 'wrap' }}>
            ...
            <div style={{
              ...
              borderRadius: 999, background: 'rgba(58,38,8,0.08)',
          ...
          <motion.div variants={fadeUp} style={{ display: 'flex', gap: '1rem', justifyContent: 'center', flexWrap: 'wrap' }}>
            <Link to="/projects" style={{
              ...
              padding: '0.75rem 1.75rem', background: 'var(--gold)', color: '#FBF2E0',
              borderRadius: 8, fontWeight: 700, fontSize: '0.9rem',
              letterSpacing: '0.04em', transition: 'opacity 0.2s, box-shadow 0.2s',
            }}
              onMouseEnter={e => { e.currentTarget.style.opacity = '0.88'; e.currentTarget.style.boxShadow = '0 6px 20px rgba(162,62,22,0.4)' }}
            ...
            <Link to="/contact" style={{
              ...
              onMouseEnter={e => { e.currentTarget.style.borderColor = 'var(--gold)'; e.currentTarget.style.color = 'var(--gold)'; e.currentTarget.style.boxShadow = '0 4px 16px rgba(162,62,22,0.2)' }}
        ...
        <AnimatePresence>
          {!hasScrolled && (
            <motion.div
              ...
              style={{ position: 'absolute', bottom: '2rem', color: 'rgba(58,38,8,0.4)', fontSize: '0.75rem', letterSpacing: '0.1em', zIndex: 2 }}>
              scroll
            </motion.div>
          )}
        </AnimatePresence>
        ...
        <div style={{
          ...
          {STATS.map(s => (
            <StatCounter key={s.label} {...s}
              numColor="#E8B265"
              labelColor="rgba(244,241,232,0.6)"
            />
          ))}
        </div>
      </section>

      {/* ═══ SKILLS TICKER — Mid amber ═══ */}
      <section style={{ padding: '3.5rem 0', background: 'var(--bg-mid)' }}>
        <div style={{ maxWidth: 1100, margin: '0 auto', padding: '0 2rem' }}>
          <motion.p
            initial={{ opacity: 0, y: 16 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
            style={{
              textAlign: 'center', color: 'rgba(58,38,8,0.7)',
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: '1.5rem' }}>
            {WHAT_I_DO.map((card, i) => (
              <motion.div key={card.title}
                ...
                whileHover={{ y: -6, boxShadow: '0 12px 36px rgba(162,62,22,0.2)' }}
                viewport={{ once: true }}
                transition={{ delay: i * 0.1 }}
                style={{
                  background: 'var(--bg-card)',
                  border: '1px solid rgba(58,38,8,0.15)',
                  borderRadius: 12, padding: '1.75rem', cursor: 'default',
                }}>
                <motion.div
      ...
      <section style={{ padding: '5rem 2rem', background: '#1E0D03' }}>
        <motion.div
          ...
          style={{
            ...
            borderTop: '1px solid rgba(244,241,232,0.14)',
          ...
          <h2 style={{
            ...
            color: '#F4F1E8', marginBottom: '1rem',
          }}>
            Let's build something worth talking about.
          </h2>
          <p style={{ color: 'rgba(244,241,232,0.65)', marginBottom: '2rem', lineHeight: 1.7 }}>
            Roles · Ventures · AndyBot — I'm open. Let's talk.
          </p>
          <Link to="/contact" style={{
            display: 'inline-flex', alignItems: 'center', gap: '0.5rem',
            padding: '0.8rem 2rem',
            background: 'var(--gold)', color: '#FBF2E0',
            borderRadius: 8, fontWeight: 700, fontSize: '0.9rem',
            transition: 'opacity 0.2s, box-shadow 0.2s',
          }}
            onMouseEnter={e => { e.currentTarget.style.opacity = '0.88'; e.currentTarget.style.boxShadow = '0 6px 20px rgba(162,62,22,0.5)' }}
            onMouseLeave={e => { e.currentTarget.style.opacity = '1'; e.currentTarget.style.boxShadow = 'none' }}>
